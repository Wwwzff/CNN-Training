...
class PowerTransferMode:
    ...
    def plot_training(self, history):
      ...
      plt.title('Training and validation loss', label = 'val_loss')
      plt.legend()
...
if __name__ == '__main__':
    ...
    #得到数据
    train_generator = transfer.DataGen('/home/chester/Downloads/all/data/train', image_size, image_size, batch_size, True)
    validation_generator = transfer.DataGen('/home/chester/Downloads/all/data/validation', image_size, image_size, batch_size, False)
    ...
    #history_ft = transfer.train_model(model, 10, train_generator, 600, validation_generator, 600, 'resnet50_model_weights.h5', is_load_model=False)
...
model.save('/home/chester/Downloads/all/vgg_model.h5')
